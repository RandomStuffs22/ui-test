...
public class PLF_Navigation_TopNavigation_Create_EventTask extends CalendarBase{
	...
	public  void test05_InputtedValuesAreNotResetWhenChangingTypeBetweenEventOrTask() {
		...
		check(ELEMENT_TOOLBAR_TASK_CHECKBOX,2);
		Utils.pause(1000);
		info(waitForAndGetElement(ELEMENT_TOOLBAR_INPUT_EVENT_TITLE_TEXTBOX).getText());
		assert waitForAndGetElement(ELEMENT_TOOLBAR_INPUT_EVENT_TITLE_TEXTBOX).getText().equalsIgnoreCase(event2);
		assert waitForAndGetElement(ELEMENT_TOOLBAR_START_DATE).getText().equalsIgnoreCase(getCurrentDate("MM/dd/yyyy"));
	}
	...
	public  void test07_ShowItemsOfMenuAddNewEventTask() {
		...
		check(ELEMENT_TOOLBAR_EVENT_CHECKBOX, 2);
		uncheck(ELEMENT_TOOLBAR_TASK_CHECKBOX, 2);
	...
	public  void test11_ShowTheMiniCalendar() {
		...
		Utils.pause(2000);
		waitForAndGetElement(ELEMENT_TOOLBAT_MINI_CALENDAR);
